...
cfg.DATA.SPP_TRAIN_PARAMS = CN({'files_to_load': [], 'root_dir': '/home/ahabbas/data/learnDBCA/SPP_OR_Lib/train_split/', 'read_dual_converged' : False, 'need_gt': True})
...
cfg.TEST.DATA.SPP_TEST_PARAMS = CN({'files_to_load': [], 'root_dir': '/home/ahabbas/data/learnDBCA/SPP_OR_Lib/test_split/', 'read_dual_converged' : True, 'need_gt': True})
