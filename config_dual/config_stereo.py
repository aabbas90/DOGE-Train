...
cfg.TEST.DATA.DATASETS = ['STEREO_TEST']
cfg.TEST.DATA.STEREO_TEST_PARAMS = CN({'files_to_load': [], 'root_dir': '/home/ahabbas/data/learnDBCA/mrf_stereo/test_split/', 'read_dual_converged' : False, 'need_gt': False, 'need_ilp_gt': False, 'extension': '.uai'})
