...
cfg.DATA.CT_TRAIN_PARAMS = CN({'files_to_load': CT_TRAIN_FILES, 'root_dir': '/home/ahabbas/data/learnDBCA/cv_structure_pred/full_inst/', 'read_dual_converged' : False, 'need_gt': True, 'load_in_memory': True})
...
cfg.TEST.VAL_PERIOD = 1000000 # Validate after every n epoch (can be less than 1). TODO
