...
cfg.DATA.MIPLIB_VAL_PARAMS = CN({'files_to_load': ['1.lp', '2.lp', '3.lp'], 'root_dir': '/home/ahabbas/data/learnDBCA/miplib_crops/hard/', 'read_dual_converged' : True, 'need_gt': True, 'need_ilp_gt': False})
