...
#SBATCH --gres gpu:1
#SBATCH -t 0-23:59:59
#SBATCH -o out_dual/slurm_spp/%j_qaplib.out
...
python train_dual_ascent.py --config-file config_dual/config_spp_full.py \
    OUT_REL_DIR SPP/nobackup/v1_${FEATURE_EXTRACTOR_DEPTH}_${DUAL_PRED_DEPTH}_${VAR_FEATURE_DIM}_${CON_FEATURE_DIM}_${EDGE_FEATURE_DIM}_${NUM_ROUNDS_WITH_GRAD}_${NUM_DUAL_ITR}_${GRAD_DUAL_ITR_MAX_ITR}_${SKIP_CONNECTIONS}_${NUM_ROUNDS_TRAIN}_${PREDICT_OMEGA}_${BASE_LR}_${USE_RELATIVE_GAP_LOSS}_${NUM_HIDDEN_LAYERS_EDGE} \
