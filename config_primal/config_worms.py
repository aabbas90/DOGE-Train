...
cfg.DATA.GM_WORMS_VAL_PARAMS = CN({'files_to_load': ['2.lp'], 'root_dir': '/home/ahabbas/data/learnDBCA/cv_structure_pred/graph-matching/worms/train_split/', 'read_dual_converged' : True}) 
...
cfg.TRAIN.LOSS_DISCOUNT_FACTOR = 0.99
