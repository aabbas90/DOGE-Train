...
MAX_NUM_ROUNDS=3
USE_LSTM=True
LOSS_DISCOUNT_FACTOR=0.05
START_EPISODIC_TRAINING_AFTER_EPOCH=100
MM_AGR_LOSS_WEIGHT=1.0
MM_TANH_MULT=5e1
FOLDER_NAME=${FEATURE_EXTRACTOR_DEPTH}_${PRIMAL_PRED_DEPTH}_${VAR_FEATURE_DIM}_${CON_FEATURE_DIM}_${EDGE_FEATURE_DIM}_${NUM_HIDDEN_LAYERS_EDGE}_${NUM_DUAL_ITR}_${GRAD_DUAL_ITR_MAX_ITR}_${USE_LAYER_NORM}_${LR}_${LOSS_MARGIN}_${NUM_ROUNDS_WITH_GRAD}_${MIN_PERTURBATION}_${MAX_NUM_ROUNDS}_${USE_LSTM}_${LOSS_DISCOUNT_FACTOR}_${MM_AGR_LOSS_WEIGHT}_${MM_TANH_MULT}

echo ${FOLDER_NAME}
#--test-non-learned
python train_primal_rounding.py \
    --config-file config_primal/config_worms_single.py \
    ...
    TRAIN.START_EPISODIC_TRAINING_AFTER_EPOCH ${START_EPISODIC_TRAINING_AFTER_EPOCH} \
    ...
    OUT_REL_DIR WORMS/nobackup/v_single/v4_fix_rounds_${FOLDER_NAME}
