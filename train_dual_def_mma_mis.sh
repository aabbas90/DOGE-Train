...
NUM_ROUNDS_TEST=200
# --test-non-learned
python train_dual_ascent.py --config-file config_dual/config_mis.py --test-precision-float \
    OUT_REL_DIR MIS/nobackup/vf/v6_mixed_prec_random_num_itrs_${FEATURE_EXTRACTOR_DEPTH}_${DUAL_PRED_DEPTH}_${VAR_FEATURE_DIM}_${CON_FEATURE_DIM}_${EDGE_FEATURE_DIM}_${NUM_ROUNDS_WITH_GRAD}_${NUM_DUAL_ITR}_${GRAD_DUAL_ITR_MAX_ITR}_${NUM_ROUNDS_TRAIN}_${PREDICT_OMEGA}_${PREDICT_DIST_WEIGHTS}_${BASE_LR}_${USE_RELATIVE_GAP_LOSS}_${NUM_HIDDEN_LAYERS_EDGE}_${USE_NET_SOLVER_COSTS}_${FREE_UPDATE}_${FREE_UPDATE_LOSS_WEIGHT} \
