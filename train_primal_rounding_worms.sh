...
python train_primal_rounding.py --config-file config_primal/config_worms.py \
    ...
    OUT_REL_DIR WORMS/v1_var_pert_${FEATURE_EXTRACTOR_DEPTH}_${PRIMAL_PRED_DEPTH}_${VAR_FEATURE_DIM}_${CON_FEATURE_DIM}_${EDGE_FEATURE_DIM}_${NUM_DUAL_ITR}_${GRAD_DUAL_ITR_MAX_ITR}_${USE_LAYER_NORM}_${LR}_${PREDICT_DIST_WEIGHTS}_${LOSS_MARGIN}_${NUM_ROUNDS_WITH_GRAD}
