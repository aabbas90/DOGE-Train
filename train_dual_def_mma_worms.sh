...
OUT_REL_DIR WORMS/nobackup/v_new/v4_proposed_start_step_3${FEATURE_EXTRACTOR_DEPTH}_${DUAL_PRED_DEPTH}_${VAR_FEATURE_DIM}_${CON_FEATURE_DIM}_${EDGE_FEATURE_DIM}_${NUM_ROUNDS_WITH_GRAD}_${NUM_DUAL_ITR}_${GRAD_DUAL_ITR_MAX_ITR}_${NUM_ROUNDS_TRAIN}_${PREDICT_OMEGA}_${PREDICT_DIST_WEIGHTS}_${BASE_LR}_${USE_RELATIVE_GAP_LOSS}_${NUM_HIDDEN_LAYERS_EDGE}_${USE_NET_SOLVER_COSTS}_${FREE_UPDATE}_${USE_LSTM_VAR}_${USE_CELU_ACTIVATION}_${SCALE_FREE_UPDATE}_${FREE_UPDATE_LOSS_WEIGHT}_${USE_SEPARATE_MODEL_LATER_STAGE} \
