...
python train_dual_ascent.py --config-file config_dual/config_worms.py \
    OUT_REL_DIR WORMS/v7/v1_lb_grad_wo_constant_${FEATURE_EXTRACTOR_DEPTH}_${DUAL_PRED_DEPTH}_${VAR_FEATURE_DIM}_${CON_FEATURE_DIM}_${EDGE_FEATURE_DIM}_${NUM_ROUNDS_WITH_GRAD}_${NUM_DUAL_ITR}_${GRAD_DUAL_ITR_MAX_ITR}_${SKIP_CONNECTIONS}_${NUM_ROUNDS_TRAIN}_${PREDICT_OMEGA} \
