...
#SBATCH --gres gpu:1
#SBATCH -t 0-11:59:59
#SBATCH -o out_dual/slurm_new/%j_eval.out
...
NUM_DUAL_ITR_TEST=200
NUM_ROUNDS_TEST=50
DUAL_IMPROVEMENT_SLOPE_TEST=1e-9
OUTPUT_ROOT_DIR="out_dual/WORMS/nobackup/v_new/v4_proposed_start_step_31_1_16_16_8_3_20_20_20_True_True_1e-3_False_2_True_True_True_False_False_0.0_True/"
CKPT_REL_PATH="out_dual/WORMS/nobackup/v_new/v4_proposed_start_step_31_1_16_16_8_3_20_20_20_True_True_1e-3_False_2_True_True_True_False_False_0.0_True/default/version_0/checkpoints/last.ckpt"
OUT_REL_DIR='test_non_learned_'${NUM_DUAL_ITR_TEST}_${NUM_ROUNDS_TEST}_${DUAL_IMPROVEMENT_SLOPE_TEST}
...
python train_dual_ascent.py --eval-only --test-precision-float --test-non-learned --only-test-non-learned \
